...
(ns juxt.reap.encoders
  (:require
   [juxt.reap.encoders.rfc7231 :as rfc7231]
   [juxt.reap.encoders.rfc7233 :as rfc7233]
   [juxt.reap.encoders.rfc7235 :as rfc7235]))
...
(defn format-http-date [^java.util.Date inst]
  ...
  (precompiled-http-date {:juxt.reap.rfc7231/date inst}))
