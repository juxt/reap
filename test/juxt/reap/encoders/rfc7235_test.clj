...
(ns juxt.reap.encoders.rfc7235-test
  (:require
   [clojure.test :refer [deftest is]]
   [juxt.reap.regex :as re]
   [juxt.reap.decoders.rfc7235 :as decoder]
   [juxt.reap.encoders.rfc7235 :as encoder]))
...
(comment
  ((encoder/auth-param {})
   #:juxt.reap.rfc7235{:auth-param-name "foo" :auth-param-value "bar"}))
