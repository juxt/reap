...
(ns juxt.reap.decoders.rfc7231-test
  (:require
...
(deftest accept-language-test
  (is
   (= [{:juxt.reap.rfc4647/language-range "en-GB"}
       {:juxt.reap.rfc4647/language-range "en-US" ::rfc7231/qvalue 0.8}
       {:juxt.reap.rfc4647/language-range "en" ::rfc7231/qvalue 0.5}
       {:juxt.reap.rfc4647/language-range "it" ::rfc7231/qvalue 0.3}]
      ((dec/accept-language {})
  ...
  (are [input expected]
    ...
    ", , de ;q=0.7" [{:juxt.reap.rfc4647/language-range "de" ::rfc7231/qvalue 0.7}]

    "en-US ; q=1.0 ," [{:juxt.reap.rfc4647/language-range "en-US", ::rfc7231/qvalue 1.0}]

    "*;q=0.9 , fr;q=0.9" [{:juxt.reap.rfc4647/language-range "*", ::rfc7231/qvalue 0.9}
                          {:juxt.reap.rfc4647/language-range "fr", ::rfc7231/qvalue 0.9}]

    ", *" [{:juxt.reap.rfc4647/language-range "*"}]

    ", , fr ;q=0.7" [{:juxt.reap.rfc4647/language-range "fr", ::rfc7231/qvalue 0.7}]

    "de;q=1.0" [{:juxt.reap.rfc4647/language-range "de", ::rfc7231/qvalue 1.0}]

    ", de;q=1.0" [{:juxt.reap.rfc4647/language-range "de", ::rfc7231/qvalue 1.0}]

    "en-US ;q=0.7 ," [{:juxt.reap.rfc4647/language-range "en-US", ::rfc7231/qvalue 0.7}]

    ", * ," [{:juxt.reap.rfc4647/language-range "*"}]

    ", * ,en-US ;q=0.7 , *"
    [{:juxt.reap.rfc4647/language-range "*"}
     {:juxt.reap.rfc4647/language-range "en-US", ::rfc7231/qvalue 0.7}
     {:juxt.reap.rfc4647/language-range "*"}]))
...
(deftest content-language-test
  (is
   (= ["en" "de"]
      (map :juxt.reap.rfc5646/language ((dec/content-language {}) (re/input "en,de"))))
   (= [["en" "US"] ["de" nil]]
      (map (juxt :juxt.reap.rfc5646/language ::rfc7231/region)))))
