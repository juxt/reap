...
----
[#:juxt.reap.alpha{:media-range "text/html",
                   :type "text",
                   :subtype "html",
                   :parameters {}}
 #:juxt.reap.alpha{:media-range "application/xhtml+xml",
                   :type "application",
                   :subtype "xhtml+xml",
                   :parameters {}}
 #:juxt.reap.alpha{:media-range "application/xml",
                   :type "application",
                   :subtype "xml",
                   :parameters {},
                   :qvalue 0.9}
 #:juxt.reap.alpha{:media-range "*/*",
                   :type "*",
                   :subtype "*",
                   :parameters {},
                   :qvalue 0.8}]
